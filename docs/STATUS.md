...
Оновлено: 2026-09-03 (після A4-верстки, фінальної пагінації та повного PDF visual QA).
...
1. Сергій переглядає фінальну A4-версію з помаранчевим маркуванням.
2. Лише після прямого підтвердження Сергія прибрати `#E65900`, зробити final PDF і передати Тетяні готову записку.
3. Не resolve supervisor comment без окремого рішення.
