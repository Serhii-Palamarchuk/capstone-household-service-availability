...
- `для чого і де?` — comment прив’язаний безпосередньо до фрази `штучного інтелекту` у Декларації академічної доброчесності. 2026-09-01 декларацію уточнено за фактичним використанням інструментів: ChatGPT — аналіз вимог/feedback, архітектурні рішення, пошук і перевірка інформації, документація; Codex — основний AI-асистент під час реалізації, доопрацювання, рефакторингу й автоматизованого тестування коду; Claude — епізодичний додатковий асистент під час роботи з кодом. Остаточні рішення, перевірка джерел і фактичні результати залишаються відповідальністю автора. Comment не resolve до підтвердження Тетяною.
...
- Декларація академічної доброчесності — конкретизована за фактичним використанням ChatGPT, Codex і Claude;
