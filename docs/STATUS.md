...
Оновлено: 2026-09-05 (Week 6 accepted; перехід до Week 7).
...
- Поточний bibliography checkpoint: **26 фактично оформлених джерел**. Feedback: збільшити до приблизно **35–40**, використовуючи релевантну технічну документацію, наукові статті та/або книги з електротехнічних основ/формул; не додавати джерела, які фактично не використані в тексті.
- Поточний reporting focus тимчасово повертається до **targeted explanatory-note fix**; після закриття feedback — назад до Week 7 presentation / speech / live demo.
...
- Поточний стан comments: **30 total, 1 open**. Потрібна лише адресна робота з bibliography/evidence; scope/MVP/архітектуру не змінювати.
...
1. Опрацювати новий supervisor comment щодо bibliography: підняти кількість фактично використаних джерел з 26 до орієнтовно 35–40 за рахунок релевантної офіційної документації, peer-reviewed статей і/або авторитетних книг.
2. Для кожного нового джерела додати реальне посилання у відповідний абзац записки; не наповнювати bibliography невикористаними позиціями.
3. Після правок повторити bibliography/citation consistency check і PDF visual QA, потім закрити comment.
4. Не змінювати scope/MVP/архітектуру без нового окремого рішення.
5. Після стабілізації записки повернутися до фінальної презентації та сценарію захисту/live demo.
