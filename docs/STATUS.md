...
Оновлено: 2026-09-03 (після A4-верстки, фінальної пагінації, PDF visual QA, закриття supervisor comments і фінального перегляду записки Сергієм).
...
1. Зробити final PDF із поточної перевіреної версії та передати Тетяні готову пояснювальну записку.
2. Після завершення записки підготувати й відрепетирувати 15-хвилинне фінальне демо та Week 6 materials.
