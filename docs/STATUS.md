...
- Після змін PDF має **55 сторінок**; bibliography — стор. **52–54**; Appendix A — стор. **55**. Зміст, список таблиць і список рисунків синхронізовано з новою пагінацією; PDF visual QA — без clipping/overlap у перевірених сторінках.
