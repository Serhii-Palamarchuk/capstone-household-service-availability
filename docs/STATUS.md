...
1. Пояснювальна записка змістовно стабілізована; bibliography feedback закрито, comments — 0 open.
2. Перед остаточною здачею за потреби прибрати orange marking з останніх адресних правок і виконати фінальний PDF visual QA.
3. Не змінювати scope/MVP/архітектуру без нового окремого рішення.
4. Поточний focus — фінальна презентація та сценарій захисту/live demo.
