...
Оновлено: 2026-09-03 (після підготовки Week 6 до повторного подання).
...
- Повторне подання Week 6 ще не вважати фактом до підтвердження Сергія.
...
1. Повторно подати Week 6 report разом з актуальною пояснювальною запискою та зафіксувати acceptance/новий feedback.
2. Паралельно перейти до підготовки фінальної презентації та 15-хвилинного сценарію захисту/live demo без розширення MVP.
3. Підготувати версію пояснювальної записки для антиплагіату за офіційною процедурою.
4. Перед фінальною подачею виконати контрольний PDF export/visual QA після будь-яких наступних правок.
