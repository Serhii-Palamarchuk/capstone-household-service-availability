...
Оновлено: 2026-09-04 (після повторного повернення Week 6 на доопрацювання).
...
- Поточний статус Week 6: **returned for revision / awaiting joint consultation**; accepted НЕ вважати.
...
1. До консультації не робити нових широких або припущених правок у пояснювальній записці чи Week 6 report.
2. На консультації разом із керівником зафіксувати точні правки; після консультації внести лише адресні зміни та повторити PDF visual QA.
3. Після фактичного виправлення повторно подати Week 6 і зафіксувати acceptance/новий feedback.
4. Презентацію, 15-хвилинний сценарій захисту/live demo та антиплагіат продовжити після стабілізації записки; scope/MVP не розширювати.
