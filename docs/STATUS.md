...
Оновлено: 2026-09-06 (Week 7 accepted; роботу поставлено на паузу до plagiarism feedback).
...
1. **PAUSED:** чекати фактичного plagiarism feedback / результату перевірки на плагіат.
2. До отримання feedback не вносити нових змін у scope, MVP, архітектуру, пояснювальну записку або презентацію без прямої вказівки користувача.
3. Після отримання plagiarism feedback спочатку зафіксувати його в Context і STATUS, потім визначити необхідні точкові дії.
4. Не заявляти результат plagiarism check, доки його фактично не отримано.
