...
- Пояснювальну записку відправлено на перевірку; окремий plagiarism report ще не вважати отриманим без фактичного підтвердження користувача.
- Поточний reporting focus: **Week 7** — фіналізація матеріалів захисту, презентація, сценарій виступу/live demo та Week 7 report.
